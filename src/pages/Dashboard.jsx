...
function Dashboard() {
  ...
  const addTask = () => {
    if (!newTask.name.trim() || !user?.uid) return;
                ...
                <div className="bg-slate-800 rounded-2xl p-4 text-xs text-slate-100">
                  ...
                  <div className="grid grid-cols-7 gap-1 text-[10px] text-center">
                    {calendarDays.map((day) => {
                      ...
                      const baseClass =
                        "inline-flex items-center justify-center rounded-full px-1 py-[2px]";
                      ...
                      {showDeleteModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                          <div className="bg-white rounded-2xl shadow-2xl p-8 min-w-[300px] flex flex-col items-center">
                            <h3 className="text-lg font-semibold text-slate-900 mb-4">¿Eliminar tarea?</h3>
                            <p className="text-slate-700 mb-6 text-center">Esta acción no se puede deshacer. ¿Estás seguro de que quieres eliminar esta tarea?</p>
                            <div className="flex gap-4">
                              ...
                              <button
                                ...
                                className="px-5 py-2 rounded-xl bg-slate-300 text-slate-900 font-semibold shadow hover:bg-slate-400 transition"
                              >
                                Cancelar
                              </button>
                            </div>
